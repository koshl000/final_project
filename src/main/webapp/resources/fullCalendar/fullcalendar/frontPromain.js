...
var scheduleRegist = (function($){
	...
	var inputVal = function(val){
		...
		$schedule.find("#lectureName").text(tmptitle[0]);
		$schedule.find("#sTitle").text(tmptitle[1]);
		$schedule.find("#start-date").text(data.start.substring(0, 10));
		$schedule.find("#end-date").text(data.end.substring(0, 10));
		
		$schedule.find("#stTime").text(data.start.substring(11, 19));
		$schedule.find("#edTime").text(data.end.substring(11, 19));
