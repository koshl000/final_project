...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/res/fullCalendar/fullcalendar/frontPromain.js"></script>
<script
...
<!--                                 </div> -->
				...
				<div class="color-single nk-green mg-t-30" style="float:left; margin-right: 20px;">
                                    <h2>과제물관리</h2>
                                    <a href="${pageContext.request.contextPath}/professor/assignment" style="color:#fff">  
